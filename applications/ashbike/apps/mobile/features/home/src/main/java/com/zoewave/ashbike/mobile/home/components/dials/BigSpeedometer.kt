...
import com.zoewave.probase.core.ui.theme.CustomColors
import com.zoewave.probase.core.ui.theme.LocalCustomColors
...
fun BigSpeedometer(
    ...
    val speedTextColor =
        calculateColorForSpeed(
            animatedSpeedFraction,
            customColors
        )
