...
// import com.zoewave.probase.core.ui.theme.iconColorSpeed // Not used in this version
...
import com.zoewave.ashbike.mobile.home.components.main.StatCard
import com.zoewave.ashbike.mobile.home.components.main.StatItem
...
import com.zoewave.probase.core.ui.theme.iconColorBikeActive
import com.zoewave.probase.core.ui.theme.iconColorCalories
...
fun StatsSectionPreview() {
    ...
    val uiState = HomeUiState.Success(bikeData = bikeData)
    StatsSection(
        uiState = uiState,
