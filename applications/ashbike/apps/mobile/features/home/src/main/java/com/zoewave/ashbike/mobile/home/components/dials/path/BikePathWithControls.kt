package com.zoewave.ashbike.mobile.home.components.dials.path
...
fun BikePathWithControls(
    ...
    uiState: HomeUiState.Success, // Just pass the state object
    ...
    val onHomeEventStable = remember { { event: HomeEvent -> onHomeEvent(event) } }
    val onStartRide = remember { { onHomeEvent(HomeEvent.StartRide) } }
    val onStopRide = remember { { onHomeEvent(HomeEvent.StopRide) } }
    ...
    if (showDistanceDialog) {
        ...
        val onDismissRequest = remember { { onHomeEvent(HomeEvent.DismissSetDistanceDialog) } }
            ...
            confirmButton = {
                TextButton(onClick = {
                    text.toFloatOrNull()?.let { entered ->
                        onHomeEvent(HomeEvent.SetTotalDistance(entered))
                    }
                }) {
...
fun BikePathWithControlsPreview() {
    ...
    BikePathWithControls(uiState = uiState, onHomeEvent = {})
}
*/
