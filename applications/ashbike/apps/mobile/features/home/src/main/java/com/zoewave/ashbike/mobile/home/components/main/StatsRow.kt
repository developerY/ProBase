...
import com.zoewave.probase.core.ui.theme.iconColorAvgSpeed
import com.zoewave.probase.core.ui.theme.iconColorDistance
import com.zoewave.probase.core.ui.theme.iconColorDuration
import com.zoewave.probase.core.ui.theme.iconColorElevation
...
// StatsRowEvent is no longer needed here if StatsRow takes HomeUiState and doesn't emit its own specific events
...
fun StatsRow(
    ...
    uiState: HomeUiState.Success, // Changed from StatsRowUiState
...
fun StatsRowPreview() {
    ...
    val previewUiStateOn = HomeUiState.Success(demoInfoOn)
...
fun StatsRowPreviewOff() {
    val demoInfoOff = BikeRideInfo(
     ...
     val previewUiStateOff = HomeUiState.Success(demoInfoOff)
