...
object RoutineDefaults {
    fun getMorningRoutine(): List<RoutineStep> = listOf(
        RoutineStep(
            id = "m1", 
            title = "Stage 1: Wake Up & Anchor", 
            subtitle = "Psychological Initialization",
            description = "The way you wake up dictates the neurocognitive trajectory of your entire day. Instead of a passive wake-up, claim immediate psychological control by adopting the South Korean \"God-Saeng\" mindset. This involves pursuing continuous self-development and taking micro-control over your daily habits. Use this moment to review your daily plan or set a single micro-goal; documenting this early-morning victory generates an immediate dopaminergic reward that builds consistency."
        ),
        RoutineStep(
            id = "m2", 
            title = "Stage 2: Mouth Hygiene", 
            subtitle = "Clear & Protect",
            description = "Before drinking water, you must clear the overnight bacterial biofilm from your mouth. Dental science recommends flossing and brushing your teeth first, followed immediately by tongue scraping while a little toothpaste remains in your mouth. Gently pulling a scraper from the back of the tongue to the front removes the volatile sulfur compounds that cause bad breath much more effectively than a toothbrush. This also protects the beneficial oral bacteria that convert dietary nitrates into nitric oxide, a molecule crucial for cardiovascular health."
        ),
        RoutineStep(
            id = "m3", 
            title = "Stage 3: Hydrate", 
            subtitle = "Enteric Activation via Yin-Yang Water",
            description = "Drinking ice water first thing in the morning shocks the digestive system, while plain hot water lacks dynamic energy. The optimal hydration method uses the traditional Korean practice of \"Eum-yang-tang\" (Yin-Yang water). Fill a glass two-thirds with freshly boiled water, then immediately top it off with cold water. This specific pour sequence creates active thermal circulation, which safely promotes internal heat distribution, stimulates the enteric nervous system, and alleviates morning digestive sluggishness."
        ),
        RoutineStep(
            id = "m4", 
            title = "Stage 4: Move", 
