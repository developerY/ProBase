...
- [x] Implement Adaptive Home and Settings Layouts
    - [x] Create `AdaptiveHomeScreen` with dual-pane support
    - [x] Refactor `HomeOverviewScreen` for modularity
    - [x] Constrain `SettingsScreen` width on large screens
    - [x] Update navigation graph to use adaptive home
