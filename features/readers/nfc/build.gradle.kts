...
android {
    ...
    namespace = "com.zoewave.probase.features.readers.nfc"
}
...
dependencies {
    ...
    // implementation(project(":core:util")) // Use if needed
    ...
    // --- 3. UI & Compose ---
    // 'library.compose' plugin adds the BOM and tooling automatically.
