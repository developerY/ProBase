...
def populate():
    # Source for MARKETING SUMMARY (from summary.md)
    summary_file = "/Users/developer/AndroidStudioProjects/ProBase/server/docs/Catalog/summary.md"
    # Source for SCIENTIFIC DESCRIPTION (from Product_Description.md)
    ...
    print(f"✅ Successfully updated {updated_count} notes files.")
