...
include(":applications:ashbike:apps:wear:featuers:home")
include(":applications:ashbike:apps:wear:featuers:rides")
include(":applications:ashbike:apps:wear:featuers:settings")
