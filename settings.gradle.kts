...
include(":features:health:hydration")
include(":features:health:nutrition")
include(":features:camera")
include(":features:camera:productcapture")
include(":features:microphone")
include(":features:calendar")
include(":features:xr:ar:naillab")
include(":features:xr:ar:facelab")
include(":features:xr:glass")
include(":features:xr:glass:samples")
include(":features:xr:glass:translation")
include(":features:xr:glass:vision")
...
include(":applications:kocolor:features:fda")
include(":applications:kocolor:features:routines")
include(":applications:kocolor:features:cosmetics")
include(":applications:kocolor:features:chemicals")
include(":applications:kocolor:features:products")
include(":applications:kocolor:features:colors")
include(":applications:kocolor:features:starterpack")
include(":applications:kocolor:features:stitch")
include(":applications:kocolor:features:store")
include(":applications:kocolor:features:boxcapture")
include(":applications:kocolor:features:clothingcapture")
include(":applications:kocolor:features:makeupapi")
include(":applications:kocolor:features:obf")
include(":applications:kocolor:features:seasonal_trends")
// include(":applications:kocolor:features:stitch")
